...
ควบคุม workflow ของ SecurityGuardManagementSystem delivery ตั้งแต่รับ requirement, เลือก agents, แตก task, จัด dependency, รวม handoff และตัดสินใจ readiness ก่อนส่งต่อ implementation/release.
...
- clarify business goal and impacted SecurityGuardManagementSystem domain
...
## SecurityGuardManagementSystem Domain Classifier
...
2. Impacted SecurityGuardManagementSystem Domains
3. Source Evidence
...
```txt
ทำหน้าที่ Orchestrator ของ SecurityGuardManagementSystem
