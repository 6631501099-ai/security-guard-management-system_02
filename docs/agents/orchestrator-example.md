# Orchestrator Example: SecurityGuardManagementSystem Source-First Change

Use this example as a structure only. Replace every route, model, permission path, and UI component with evidence from SecurityGuardManagementSystem source before implementation.
