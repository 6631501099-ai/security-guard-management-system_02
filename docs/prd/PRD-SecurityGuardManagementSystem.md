# PRD: SecurityGuardManagementSystem

## Document Control

| Field | Value |
|---|---|
| Product | SecurityGuardManagementSystem |
| Project code | securityguardmanagementsystem |
| Version | 0.1 |
...
| Public domain | `security-guard-management-system.mfu.ac.th` |
...
SecurityGuardManagementSystem is agreement management application integrated with IAM for SecurityGuardManagementSystem registry workflows, account directory, security permissions, settings, and deployment through Docker.

Detected package names at generation time:

| Runtime | Package |
|---|---|
| Backend | `securityguardmanagementsystem-api` |
| Frontend | `securityguardmanagementsystem-frontend` |
...
- 9: app.use(path + '/securityguardmanagementsystem', securityguardmanagementsystemRoutes);
...
| securityguardmanagementsystem | `backend-node/server/Project/securityguardmanagementsystem` |
...
| securityguardmanagementsystem | `frontend-vue/src/projects/views/securityguardmanagementsystem` |
...
### FR-SecurityGuardManagementSystem-001 Authentication And Session
...
### FR-SecurityGuardManagementSystem-002 Account Directory And Lifecycle
...
### FR-SecurityGuardManagementSystem-003 Project Business Workflows
...
### FR-SecurityGuardManagementSystem-004 Security And Permission Management
...
### FR-SecurityGuardManagementSystem-005 Settings And Operations
