...
| PRD | `docs/prd/PRD-security-guard-management-system.md` | |
...
|---|---|---|---|---|---|---:|---|---|---|---|---|---|
| security-guard-management-system-TASK-001 | Source discovery | Orchestrator | AI | none | pending | 0 | not started | | | none | read source | T1-T4 evidence |
