# AI-WORKFLOW: Security Guard Management System

อัปเดตจาก source repo `security-guard-management-system` ณ วันที่ 2026-06-18
...
| 3 | `docs/prd/PRD-security-guard-management-system.md` | product requirement truth |
...
|---|---|
| Task ID | stable ID such as `security-guard-management-system-TASK-001` |
...
| `docs/prd/PRD-security-guard-management-system.md` | Product requirement truth, or replace with the actual project PRD path. |
...
- no unresolved `Security Guard Management System`, `security-guard-management-system`, route, package, or PRD placeholders remain in control docs
