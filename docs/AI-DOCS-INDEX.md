# Security Guard Management System AI Documentation Index

This docs set controls AI-assisted delivery for `security-guard-management-system`. Keep it aligned with source code, tests, and release evidence.
...
| `docs/prd/PRD-security-guard-management-system.md` | Product requirement truth, or replace with the actual PRD path used by this project. | yes |
