# T1-T20 Change Document: SecurityGuardManagementSystem 2FA OTP Paste Support

## T1 Change Title

| Field | Value |
|---|---|
| Change ID | SecurityGuardManagementSystem-2FA-OTP-PASTE-20260605 |
| Module | SecurityGuardManagementSystem frontend 2FA dialog |
| Date | 2026-06-05 |
...
- Post-deploy Docker health passed for `securityguardmanagementsystem-backend-1`, `securityguardmanagementsystem-frontend-1`, and `securityguardmanagementsystem-redis-1`.
- Server localhost smoke passed: web returned `200`; unauthenticated `/api/v1/auth/me` returned `401`.
- Public DNS smoke pending: `https://security-guard-management-system.mfu.ac.th/` did not resolve from the test client.
...
- Release: rebuild and deploy SecurityGuardManagementSystem frontend.
