...
module.exports = {
  'Security Guard Management System Operations page renders system operating dashboard': function (browser) {
    const devServer = process.env.VUE_DEV_SERVER_URL
    const expectedHeading = 'SecurityGuardManagementSystem Operating Desk'
