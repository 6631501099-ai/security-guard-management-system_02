...
module.exports = {
  'Email Template Management action button uses the expected SecurityGuardManagementSystem style': function (browser) {
    browser
    ...
    browser
      ...
      .executeAsync(function (done) {
        ...
        page.deliveryForm.replyTo = 'ops@securityguardmanagementsystem.example.com'
        ...
        browser.assert.equal(result.value.replyTo, 'ops@securityguardmanagementsystem.example.com')
  ...
  'Custom Email Template appears in Workflow Actions': function (browser) {
    ...
    browser
      ...
      .executeAsync(function (done) {
        ...
        modal.local.description = 'SecurityGuardManagementSystem notification when a payment expires.'
        ...
        page.saveTemplate({
          ...
          description: 'SecurityGuardManagementSystem notification when a payment expires.',
