...
export default {
  ...
  accounts(method, data) {
    switch (method) {
      ...
      case 'remove-securityguardmanagementsystem-access':
        return instance.delete(`/api/v1/accounts/${data && (data.id || data._id)}/securityguardmanagementsystem-access`);
      case 'lifecycle':
  ...
  securityguardmanagementsystemDocuments(method, data) {
    switch (method) {
      case 'stats':
        return instance.get('/api/v1/securityguardmanagementsystem/documents/stats', { params: data || {} });
      case 'list':
        return instance.get('/api/v1/securityguardmanagementsystem/documents', { params: data || {} });
      case 'create':
        return instance.post('/api/v1/securityguardmanagementsystem/documents', data || {});
      case 'update':
        return instance.put(`/api/v1/securityguardmanagementsystem/documents/${data && (data.id || data._id)}`, data || {});
      case 'delete':
        return instance.delete(`/api/v1/securityguardmanagementsystem/documents/${data && (data.id || data._id)}`);
      case 'seed-demo':
        return instance.post('/api/v1/securityguardmanagementsystem/documents/seed-demo', data || {});
      default:
        break;
    }
  },
