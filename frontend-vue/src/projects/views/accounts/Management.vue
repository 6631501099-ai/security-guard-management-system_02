<template>
  <div class="account-page">
    ...
    <AccountDirectoryTable
      ...
      @remove-securityguardmanagementsystem-access="removeSecurityGuardManagementSystemAccess"
...
export default {
  ...
  methods: {
    ...
    async removeSecurityGuardManagementSystemAccess (item) {
      if (!(item && item._id)) return
      try {
        ...
        if (!confirmed) return
        await this.$store.dispatch('accounts/removeSecurityGuardManagementSystemAccess', item)
