...
const PROFILE = {
  ...
  eyebrow: 'Security Guard Management System Operations',
  title: 'SecurityGuardManagementSystem Operating Desk',
  ...
  boardMeta: 'SecurityGuardManagementSystem operation lanes',
  timelineMeta: 'SecurityGuardManagementSystem office rhythm',
  metrics: [
    { label: 'Review queue', value: '18', hint: '5 legal checks pending', icon: 'cil-list-rich', accent: 'amber' },
    { label: 'Active SecurityGuardManagementSystems', value: '126', hint: 'Across partner units', icon: 'cil-check-circle', accent: 'green' },
  ...
  board: [
    ...
    { lane: 'Approval Routing', detail: 'Executive approval and signatory tracking', owner: 'SecurityGuardManagementSystem Secretariat', throughput: '7 approvals', status: 'On Track' },
