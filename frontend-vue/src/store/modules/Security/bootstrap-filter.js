const PROJECT_PERMISSION_TYPE_TITLE = process.env.VUE_APP_PROJECT_PERMISSION_TYPE_TITLE || 'Security Guard Management System Administration'
const PROJECT_PERMISSION_ROOT_PATH = process.env.VUE_APP_PROJECT_PERMISSION_ROOT_PATH || '/security-guard-management-system/security/permission'
const PROJECT_APP_ID = process.env.VUE_APP_PROJECT_APP_ID || 'securityguardmanagementsystem'
...
export function normalizeSecurityGuardManagementSystemData (data) {
