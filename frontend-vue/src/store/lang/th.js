const th = {
    ...
    nav: {
        dashboard: "แดชบอร์ด",
        securityguardmanagementsystemRegistry: "ทะเบียน SecurityGuardManagementSystem",
        businessOperations: "งานปฏิบัติการ SecurityGuardManagementSystem",
        mfuSecurity: "MFU Security",
        mfuSecurityOverview: "ภาพรวม",
        mfuSecurityTracking: "ติดตามพิกัดสด",
        mfuSecuritySos: "แจ้งเตือนฉุกเฉิน SOS",
        mfuSecurityGuards: "รายชื่อการ์ด",
        mfuSecuritySchedule: "ตารางงาน",
        mfuSecurityTasks: "มอบหมายงาน",
        mfuSecurityIncidents: "รายงานเหตุการณ์",
        mfuSecurityLogs: "บันทึกล่าสุด",
        banks: "ธนาคาร",
        template: "ต้นแบบ",
    ...
    securityguardmanagementsystemDashboard: {
        kicker: "งานปฏิบัติการ SecurityGuardManagementSystem",
        title: "ศูนย์กลางจัดการ SecurityGuardManagementSystem",
        ...
        actions: {
            openRegistry: "เปิดทะเบียน SecurityGuardManagementSystem"
        },
        scopeItems: {
            signIn: "Google sign-in สำหรับผู้ใช้ SecurityGuardManagementSystem",
            delegatedPermission: "หน้าจอจัดการสิทธิ์ที่ส่งคำสั่งไป IAM",
            accountDirectory: "สารบบบัญชีที่ดึงสิทธิ์และข้อมูลจาก IAM",
            securityguardmanagementsystemRegistry: "ทะเบียน SecurityGuardManagementSystem การตรวจ การรายงาน และการต่ออายุ"
        },
        cards: {
            identity: {
                label: "แหล่งข้อมูลตัวตน",
                value: "IAM",
                hint: "SecurityGuardManagementSystem ไม่เก็บ identity master ซ้ำ"
            },
            apiFlow: {
                label: "รูปแบบ API",
                value: "Client Credentials",
                hint: "ใช้สำหรับการเชื่อม SecurityGuardManagementSystem ไป IAM แบบ delegated"
            },
            owner: {
    ...
    accounts: {
        directory: {
            title: "สารบบบัญชี",
            subtitle: "ตรวจสอบข้อมูลบัญชีและสิทธิ์ที่มาจาก IAM โดยไม่เก็บ identity master ซ้ำใน SecurityGuardManagementSystem",
            table: {
            ...
            messages: {
                ...
                removeConfirmMessage: "ลบ {account} ออกจาก SecurityGuardManagementSystem หรือไม่?",
                removeSuccess: "ลบบัญชีออกจาก SecurityGuardManagementSystem แล้ว",
                removeError: "ไม่สามารถลบบัญชีออกจาก SecurityGuardManagementSystem ได้",
                ...
                inviteTitle: "เชิญเข้า SecurityGuardManagementSystem",
                inviteSubtitle: "เชิญบัญชีและกำหนดสิทธิ์เข้า SecurityGuardManagementSystem",
                inviteSuccess: "เชิญบัญชีสำเร็จ",
                inviteError: "ไม่สามารถเชิญบัญชีเข้า SecurityGuardManagementSystem ได้"
            },
            invite: {
                email: "อีเมล",
                firstName: "ชื่อ",
                lastName: "นามสกุล",
                groups: "กลุ่ม SecurityGuardManagementSystem",
                groupPlaceholder: "เลือกกลุ่ม SecurityGuardManagementSystem อย่างน้อยหนึ่งกลุ่ม",
                groupRequired: "กรุณาเลือกกลุ่ม SecurityGuardManagementSystem อย่างน้อยหนึ่งกลุ่ม"
            }
        },
        permissions: {
    ...
    setting: {
        ...
        emailNotifications: {
            ...
            subtitle: "จัดการ workflow override ของ SecurityGuardManagementSystem ที่ delegated ไปยัง IAM สำหรับอีเมลด้าน identity เช่น คำเชิญบัญชี รหัส 2FA และการแจ้งเปลี่ยนสถานะบัญชี",
        ...
        workflowActions: {
            ...
            subtitle: "ตั้งค่าพฤติกรรม action ของ SecurityGuardManagementSystem email workflow ที่ delegated ไปยัง IAM เช่น ผู้รับ การเปิดใช้งาน และเงื่อนไขขณะรันระบบ",
        ...
        runtimeAccess: {
            ...
            hints: {
                trustProxy: "ใช้ X-Forwarded-* เมื่อ SecurityGuardManagementSystem อยู่หลัง reverse proxy หรือ ingress",
        ...
        databaseBackup: {
            ...
            subtitle: "จัดการ backup ฐานข้อมูลของ SecurityGuardManagementSystem ผ่าน CMS ทั้งการตั้ง auto backup, สั่ง manual, retention, download และลบไฟล์เก่า",
