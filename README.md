# SecurityGuardManagementSystem

SecurityGuardManagementSystem is an IAM-integrated agreement management system for MFU. It includes:

- Backend API for SecurityGuardManagementSystem registry records.
...
- Production domain: `https://security-guard-management-system.mfu.ac.th`
