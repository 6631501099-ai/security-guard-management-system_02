# SecurityGuardManagementSystem Environments

The SecurityGuardManagementSystem app has real env files for local, preprod, and production:
...
All environments point to the SecurityGuardManagementSystem database and use the SecurityGuardManagementSystem IAM scope set:
...
- `VUE_APP_API_BASE_URL=http://127.0.0.1:8217`
- `VUE_APP_SOCKET_URL=http://127.0.0.1:8217`
