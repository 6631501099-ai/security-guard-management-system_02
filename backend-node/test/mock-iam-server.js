...
function createMockIamServer() {
  const state = {
    ...
    serviceClients: [
      {
        ...
        allowedAudiences: ['securityguardmanagementsystem-api'],
        metadata: {
          targetSystem: 'securityguardmanagementsystem',
      ...
      },
      {
        ...
        clientSecret: 'super-secret',
        clientName: 'SecurityGuardManagementSystem IAM SDK',
        partnerId: 'security-guard-management-system-team',
        tenant: 'iam-shared',
        allowedScopes: 'security.guard.management.system.registry.read security.guard.management.system.registry.write security.guard.management.system.report.read iam.security.read iam.security.write iam.audit.read iam.accounts.read',
        allowedAudiences: ['securityguardmanagementsystem-api'],
        metadata: {
          targetSystem: 'securityguardmanagementsystem',
          ownerEmail: 'security-guard-management-system.integration@example.com'
        }
      }
    ],
    apps: [
    ...
    types: [
      ...
      {
        _id: 'type-securityguardmanagementsystem',
        title: [{ key: 'en', value: 'Security Guard Management System Administration' }],
        description: [{ key: 'en', value: 'SecurityGuardManagementSystem controls' }],
        state: true
      }
    ],
    menus: [
      ...
      },
      {
        ...
        description: [{ key: 'en', value: 'SecurityGuardManagementSystem account directory' }],
      ...
      },
      {
        ...
        description: [{ key: 'en', value: 'SecurityGuardManagementSystem account lifecycle' }],
    ...
    accounts: [
      {
        ...
        status: { key: 'ACTIVE' },
        securityGroups: [{ _id: 'group-2', title: [{ key: 'en', value: 'Security Guard Management System Admin' }] }],
  ...
  function buildToken(client, scope, audience) {
    ...
    ) || 'securityguardmanagementsystem-api';
    const payload = {
      active: true,
      access_token: token,
      token_type: 'Bearer',
      ...
      partner_id: client.partnerId || 'security-guard-management-system-team',
  ...
  async function handler(request, response) {
    ...
    if (request.method === 'GET' && pathname === '/api/v1/b2b/clients/me') {
      ...
      writeJson(response, 200, {
        ...
        metadata: {
          targetSystem: payload.client_id === 'sample-sdk' ? 'securityguardmanagementsystem' : 'securityguardmanagementsystem'
        }
      });
      return;
    }
