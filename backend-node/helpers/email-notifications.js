...
const APP_ID = 'securityguardmanagementsystem';
...
function baseContext(context) {
    ...
    return Object.assign({
        appName: getEnv('PROJECT_MAIL_APP_NAME', getEnv('APP_NAME', 'SecurityGuardManagementSystem')),
...
function senderFromConfig(config) {
    ...
    return {
        ...
        fromName: cleanString(config && config.fromName) || cleanString(config && config.appName) || 'SecurityGuardManagementSystem',
        appName: cleanString(config && config.appName) || 'SecurityGuardManagementSystem'
    };
}
