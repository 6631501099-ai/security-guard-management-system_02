...
const APP_SCOPE = 'securityguardmanagementsystem';
...
function withSecurityGuardManagementSystemScope(body) {
...
router.post('/type', canEditType, function (request, response) {
  return iamAdminClient.forwardAdminRequest(request, response, {
    method: 'post',
    path: '/security/type',
    data: withSecurityGuardManagementSystemScope(request.body),
    successStatus: 201
  });
});
