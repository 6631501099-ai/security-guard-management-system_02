...
router.delete("/accounts/:id/securityguardmanagementsystem-access", Account.onCheckAuthorization, canActionAccounts, iamAdminClient.requireScopedAccount, function (request, response) {
