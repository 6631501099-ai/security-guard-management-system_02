...
const SEED_ACCESS_PROFILES = [
    ...
    { key: 'SecurityGuardManagementSystem_OPERATIONS', defaultScope: 'division', title: { th: 'ปฏิบัติการการเงิน', en: 'Security Guard Management System Operations' } },
...
const SEED_POSITION_RULES = [
    ...
    { key: 'RULE_SecurityGuardManagementSystem', title: { th: 'สิทธิ์การเงิน', en: 'Security Guard Management System Rule' }, matchType: 'CONTAINS', matchValues: ['securityguardmanagementsystem', 'การเงิน'], orgScope: 'division', priority: 40, affiliationKeys: ['OPERATIONAL'], profileKeys: ['SecurityGuardManagementSystem_OPERATIONS'] },
