...
async function run() {
  ...
  const sessionToken = process.env.PROJECT_E2E_ADMIN_X_ACCESS_TOKEN || 'securityguardmanagementsystem-e2e-admin-token';
  ...
  const account = await AccountModel.findOneAndUpdate(
    { email: email },
    {
      $set: {
        ...
        userinfo: {
          firstName: [{ key: 'en', value: 'SecurityGuardManagementSystem' }],
        ...
        control: {
          ...
          device: [{
            ...
            deviceId: 'securityguardmanagementsystem-seed-device',
            fingerprint: 'securityguardmanagementsystem-seed-fingerprint',
            networkKey: '127.0.0',
