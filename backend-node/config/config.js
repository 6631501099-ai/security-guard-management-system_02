...
var projectCode = firstNonEmpty(process.env.PROJECT_CODE, 'securityguardmanagementsystem');
var projectName = firstNonEmpty(process.env.PROJECT_NAME, 'SecurityGuardManagementSystem');
...
var projectBaseUrl = firstNonEmpty(process.env.PROJECT_BASE_URL, process.env.BASE_SERVER_URL, 'https://security-guard-management-system.mfu.ac.th');
var projectSlug = slugify(projectCode || projectName || 'securityguardmanagementsystem') || 'securityguardmanagementsystem';
...
function buildDefaultPermissionPaths(rootPath) {
    return uniqueList([
        ...
        '/security-guard-management-system/review',
        '/security-guard-management-system/reports',
        '/operations/business',
        '/management/category',
...
var securityguardmanagementsystemPermissionRootPath = firstNonEmpty(
    process.env.PROJECT_PERMISSION_ROOT_PATH,
    process.env.PERMISSION_ROOT_PATH,
    '/' + projectSlug + '/security/permission'
);
var securityguardmanagementsystemPermissionPaths = uniqueList(
    buildDefaultPermissionPaths(securityguardmanagementsystemPermissionRootPath).concat(
        parseList(
            firstNonEmpty(
...
var securityguardmanagementsystemAuditRetentionDays = toNumber(
    firstNonEmpty(
...
module.exports = {
    ...
    security: {
        auditRetentionDays: securityguardmanagementsystemAuditRetentionDays,
        authRequire2FA: securityguardmanagementsystemAuthRequire2FA,
        permissionGroupTitle: securityguardmanagementsystemPermissionGroupTitle,
        permissionRootPath: securityguardmanagementsystemPermissionRootPath,
        permissionPaths: securityguardmanagementsystemPermissionPaths,
        permissionSource: securityguardmanagementsystemPermissionSource,
        permissionBootstrapMode: securityguardmanagementsystemPermissionBootstrapMode,
        permissionTypeTitle: securityguardmanagementsystemPermissionTypeTitle
    }
