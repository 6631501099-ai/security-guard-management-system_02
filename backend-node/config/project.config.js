...
const projectCode = firstNonEmpty(process.env.PROJECT_CODE, 'securityguardmanagementsystem');
const projectName = firstNonEmpty(process.env.PROJECT_NAME, 'SecurityGuardManagementSystem');
const projectDescription = firstNonEmpty(process.env.PROJECT_DESCRIPTION, 'Security Guard Management System student project generated from Application Infomation sheet.');
...
const projectBaseUrl = firstNonEmpty(process.env.PROJECT_BASE_URL, 'https://security-guard-management-system.mfu.ac.th');
