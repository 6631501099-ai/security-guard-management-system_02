...
## SecurityGuardManagementSystem IAM System — Backend Node.js
...
### 1.1 วัตถุประสงค์
ระบบ IAM (Identity and Access Management) ของ SecurityGuardManagementSystem Backend ทำหน้าที่:
...
- รองรับการเชื่อมต่อแบบ B2B สำหรับ SecurityGuardManagementSystem API

### 1.2 ขอบเขต (Scope)
ระบบครอบคลุม:
- SecurityGuardManagementSystem Backend API (`/api/v1/*`)
...
|--------|----------|--------|
| Security Guard Management System Admin | ผู้ดูแลระบบ SecurityGuardManagementSystem | org-wide access |
| SecurityGuardManagementSystem Manager | ผู้จัดการระดับ Unit | unit-level access |
| SecurityGuardManagementSystem Staff | พนักงานทั่วไป | self-level access |
...
#### FR-02.4 SecurityGuardManagementSystem Scope Isolation
- Groups และ Menus ต้อง filter เฉพาะที่เป็น "Security Guard Management System Administration" type
- ป้องกันการเข้าถึงข้าม SecurityGuardManagementSystem scope
...
- สร้าง default menus: dashboard, securityguardmanagementsystem registry, security, audit, accounts
