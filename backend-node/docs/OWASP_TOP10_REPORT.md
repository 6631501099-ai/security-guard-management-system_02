...
## SecurityGuardManagementSystem Backend Node.js — IAM System
...
- **ไฟล์:** `server/Project/securityguardmanagementsystem/service/securityguardmanagementsystem_document.js:34-64`
- **ปัญหา:** B2B token ต้อง introspect ทุก request → ถ้า IAM ล่ม ทุก request fail
- **ผลกระทบ:** Single point of failure สำหรับ SecurityGuardManagementSystem API
