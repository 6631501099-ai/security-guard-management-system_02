...
The generated `.gitlab-ci.yml` builds backend/frontend images, pushes them to Harbor, and deploys `docker-compose.gitlab.yml` to `/opt/service/security-guard-management-system`.
